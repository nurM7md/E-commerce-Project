  ...
  return (
    <div className="container py-10 m-auto">
      ...
      <div className="py-3 my-10 bg-gray-300 px-7 rounded-2xl">
        ...
        <div>
          <h2 className="py-2 text-xl font-semibold text-slate-950">
            Shipping Information{" "}
          </h2>
          <p className="text-lg text-slate-600">
            Name: {order.shippingInformation.name}
          </p>
          <p className="text-lg text-slate-600">
      ...
      <button className="px-3 py-2 text-lg text-white bg-green-800 rounded-lg">
        Order tracking
      </button>
      <button
        className="px-3 py-2 mx-3 text-lg text-white bg-red-800 rounded-lg"
        onClick={() => navigate("/")}
      >
        continue shopping
      </button>
